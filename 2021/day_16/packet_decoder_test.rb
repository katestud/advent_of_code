...
class PacketDecoderTest < Minitest::Test
  ...
  def test_that_part_two_works
    assert_equal 15, PacketDecoder.new("test_input_0.txt").execute_two
    assert_equal 46, PacketDecoder.new("test_input_2.txt").execute_two
    assert_equal 54, PacketDecoder.new("test_input_3.txt").execute_two

    assert_equal 144595909277, PacketDecoder.new("brad_input.txt").execute_two
  end
end
